...
impl<I2C: I2c> Tps546<I2C> {
    ...
    pub async fn init(&mut self) -> Result<()> {
        ...
        // Configure ON_OFF_CONFIG: enables both the CONTROL pin and the
        // OPERATION command as power-up/down sources.
        ...
        // Read VOUT_MODE to determine the voltage encoding format
    ...
    async fn write_config(&mut self) -> Result<()> {
        ...
        // Only write VIN_UV_WARN_LIMIT when set to a positive value
    ...
    pub async fn check_status(&mut self) -> Result<()> {
        ...
        if status_flags.contains(pmbus::StatusWord::VOUT) {
            ...
            // OV and UV faults are treated as critical
        ...
        if status_flags.contains(pmbus::StatusWord::IOUT) {
            ...
            // Overcurrent fault is treated as critical
