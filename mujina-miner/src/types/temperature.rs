...
///
/// Newtype wrapping an f32. Constructors like from_celsius make
/// the input unit explicit; additional constructors (from_fahrenheit,
/// etc.) can convert on the way in.
