...
//!
//! The stream splits into reader, writer, and control handles that
//! share ownership of the underlying file descriptor through an
//! `Arc`. This lets the control handle change baud rate and other
//! termios settings after the stream has been split for concurrent
//! I/O.
