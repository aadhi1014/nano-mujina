...
//! the pool's actual difficulty.
//!
//! Rates above roughly 10 shares/sec/thread may not be achieved: the
//! scheduler's internal per-thread share filter caps the rate.
