...
//! using its coinbase transaction parts, merkle branches, and winning extranonce2
//! value.
...
///
/// Emits JobTemplates on a fixed interval using data from block 881,423,
/// configured with the block's extranonce2 and version values.
...
impl DummySource {
    ...
    ///
    /// Builds a JobTemplate from block 881,423 with its coinbase parts, merkle
    /// branches, and extranonce2/version values.
    pub fn new(
        command_rx: mpsc::Receiver<SourceCommand>,
        event_tx: mpsc::Sender<SourceEvent>,
        shutdown: CancellationToken,
        ...
        // Extract extranonce2 from block 881,423
        ...
        // Extranonce2 range starting at the block's value
