//! Test data for BM13xx wire protocol encoding/decoding.
//!
//! Provides matching Stratum v1, Bitcoin-internal, and BM13xx wire-format
//! values for a single mining job/response pair.
//!
//! # Testing Strategy
//!
//! This module is a data source only. Tests here check internal
...
/// Raw Stratum JSON messages exchanged with the pool.
pub mod stratum_json {
  ...
  "params": [
    ...
    /// mining.submit message sent to pool. Username is redacted.
...
/// Test data for a matched Stratum job / wire job / wire response set.
pub mod esp_miner_job {
    ...
    pub mod wire_tx {
        ...
        ///
        /// All other values below are byte slices of this frame.
    ...
    /// Expected hash difficulty of the response nonce's block hash.
    ...
    /// Version mask authorized by pool (BIP320 mask).
    ///
    ...
    /// Fields from the mining.notify message
    pub mod notify {
        use super::*;
    ...
    /// Fields from the mining.submit message
    pub mod submit {
        use super::*;
